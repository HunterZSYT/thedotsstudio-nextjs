                ...
                <div className="page-header-inner tt-wrap">
                  ...
                  <div className="ph-image">
                    <div className="ph-image-inner">
                      <img loading="lazy" decoding="async" src="/assets/img/title-pages-hero-images/digital-marketing.jpg" alt="Image" />
                    </div>
                  </div>
                  ...
                  <div className="ph-caption">
                    <h1 className="ph-caption-title ph-appear">Digital Marketing</h1>
                    <div className="ph-caption-title-ghost ph-appear">Marketing</div>
                    <div className="ph-caption-subtitle ph-appear">Turning clicks into customers, 24/7</div>
                  </div> 
                ...
                <div className="tt-section">
                  <div className="tt-section-inner tt-wrap max-width-900">
                    ...
                    <div className="tt-heading tt-heading-lg">
                      ...
                      <h2 className="tt-heading-title">Digital Marketing</h2>
                    ...
                    <div className="tt-image margin-bottom-40">
                      <figure>
                        <img loading="lazy" decoding="async" className="anim-image-parallax tt-lazy" src="/assets/img/title-pages-hero-images/digital-marketing-big-picture.jpg" data-src="/assets/img/title-pages-hero-images/digital-marketing-big-picture.jpg" alt="image" />
                        <figcaption>
                          Drink Some Water
                        </figcaption>
                      </figure>
                        ...
                        <div className="ttgr-item-inner">
                          ...
                          <div className="portfolio-grid-item anim-parallax">
                            ...
                            <div className="pgi-image-holder cover-opacity-2">
                              <div className="pgi-image-inner anim-zoomin">
                                <figure className="pgi-image ttgr-height">
                                  <img loading="lazy" decoding="async" src="/assets/dots-services-img/digital-marketing/digi-market-1.png" alt="image" />
                                </figure>
                        ...
                        <div className="ttgr-item-inner">
                          ...
                          <div className="portfolio-grid-item">
                            ...
                            <div className="pgi-image-holder cover-opacity-2">
                              <div className="pgi-image-inner anim-zoomin">
                                <figure className="pgi-image ttgr-height">
                                  <img loading="lazy" decoding="async" src="/assets/dots-services-img/digital-marketing/digi-market-2.png" alt="image" />
                                </figure>
                              </div> {/* /.pgi-image-inner */}
                            </div> {/* /.pgi-image-holder */}
                            {/* /.pgi-image-wrap */}
                  ...
                  <div className="tt-section-inner tt-wrap">
                    ...
                    <div className="tt-heading tt-heading-xxlg tt-heading-stroke tt-heading-center margin-bottom-10-p anim-fadeinup">
                      <h3 className="tt-heading-subtitle text-gray">
                        Tools that turn ideas into impact.
                      </h3>
                    ...
                    <ul className="tt-logo-wall cl-col-44 anim-fadeinup">
                      <li>
                        <a className="cursor-alter" href="https://1.envato.market/tank" rel="noopener" target="_blank">
                          <img loading="lazy" decoding="async" alt="Client" src="/assets/img/tools-logo/google-ads.png" />
                        </a>
                      </li>
                      <li>
                        <a className="cursor-alter" href="https://1.envato.market/tank" rel="noopener" target="_blank">
                          <img loading="lazy" decoding="async" alt="Client" src="/assets/img/tools-logo/google-analytics.png" />
                        </a>
                      </li>
                      <li>
                        <a className="cursor-alter" href="https://1.envato.market/tank" rel="noopener" target="_blank">
                          <img loading="lazy" decoding="async" alt="Client" src="/assets/img/tools-logo/meta-nusiness-suite.png" />
                        </a>
                      </li>
                      <li>
                        <a className="cursor-alter" href="https://1.envato.market/tank" rel="noopener" target="_blank">
                          <img loading="lazy" decoding="async" alt="Client" src="/assets/img/tools-logo/meta.png" />
                        </a>
                      </li>
                      <li>
                        <a className="cursor-alter" href="https://1.envato.market/tank" rel="noopener" target="_blank">
                          <img loading="lazy" decoding="async" alt="Client" src="/assets/img/tools-logo/aherfs.png" />
                        </a>
                      </li>
                      <li>
                        <a className="cursor-alter" href="https://1.envato.market/tank" rel="noopener" target="_blank">
                          <img loading="lazy" decoding="async" alt="Client" src="/assets/img/tools-logo/yoast.png" />
                        </a>
                      </li>
                      <li>
                        <a className="cursor-alter" href="https://1.envato.market/tank" rel="noopener" target="_blank">
                          <img loading="lazy" decoding="async" alt="Client" src="/assets/img/tools-logo/_zapier.png" />
                        </a>
                      </li>
                      <li>
                        <a className="cursor-alter" href="https://1.envato.market/tank" rel="noopener" target="_blank">
                          <img loading="lazy" decoding="async" alt="Client" src="/assets/img/tools-logo/mail-chimp.png" />
                        </a>
                      </li>
                      <li>
                        <a className="cursor-alter" href="https://1.envato.market/tank" rel="noopener" target="_blank">
                          <img loading="lazy" decoding="async" alt="Client" src="/assets/img/tools-logo/hubspot.png" />
                        </a>
                      </li>
                      <li>
                        <a className="cursor-alter" href="https://1.envato.market/tank" rel="noopener" target="_blank">
                          <img loading="lazy" decoding="async" alt="Client" src="/assets/img/tools-logo/wordpress.png" />
                        </a>
                      </li>
