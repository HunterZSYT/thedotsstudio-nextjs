                ...
                <div className="page-header-inner tt-wrap">
                  ...
                  <div className="ph-image">
                    <div className="ph-image-inner">
                      <img loading="lazy" decoding="async" src="/assets/img/title-pages-hero-images/website-2.jpg" alt="Image" />
                    </div>
                  </div>
                  ...
                  <div className="ph-caption">
                    <h1 className="ph-caption-title ph-appear">Website Development</h1>
                    <div className="ph-caption-title-ghost ph-appear">Web Dev</div>
                    <div className="ph-caption-subtitle ph-appear">Your 24/7 digital sales Devs</div>
                  </div> 
                ...
                <div className="tt-section">
                  <div className="tt-section-inner tt-wrap max-width-900">
                    ...
                    <div className="tt-heading tt-heading-lg">
                      ...
                      <h2 className="tt-heading-title">Website Development</h2>
                        ...
                        <div className="ttgr-item-inner">
                          ...
                          <div className="portfolio-grid-item anim-parallax">
                            ...
                            <div className="pgi-image-holder cover-opacity-2">
                              <div className="pgi-image-inner anim-zoomin">
                                <figure className="pgi-image ttgr-height">
                                  <img loading="lazy" decoding="async" src="/assets/dots-services-img/website-development/web-dev-1.png" alt="image" />
                                </figure>
                                <div className="pgi-gradient-overlay" /> {/* /.pgi-image */}
                              </div> {/* /.pgi-image-inner */}
                            </div> {/* /.pgi-image-holder */}
                        ...
                        <div className="ttgr-item-inner">
                          ...
                          <div className="portfolio-grid-item">
                            ...
                            <div className="pgi-image-holder cover-opacity-2">
                              <div className="pgi-image-inner anim-zoomin">
                                <figure className="pgi-image ttgr-height">
                                  <img loading="lazy" decoding="async" src="/assets/dots-services-img/website-development/web-dev-2.png" alt="image" />
                                </figure>
                              </div> {/* /.pgi-image-inner */}
                            </div> {/* /.pgi-image-holder */}
                            {/* /.pgi-image-wrap */}
