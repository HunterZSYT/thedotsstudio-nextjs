export default function BrandsToolsPage() {
  return (
    <>
      <div><div className="tt-section padding-top-xlg-150 padding-bottom-xlg-150 bg-white-accent-2">
            ...
            <ul className="tt-logo-wall cl-col-44 anim-fadeinup">
              <li>
                <a className="cursor-alter" href="https://1.envato.market/tank" rel="noopener" target="_blank">
                  <img loading="eager" fetchPriority="high" decoding="async" alt="Client" src="/assets/img/tools-logo/figma.png" />
                </a>
              </li>
              <li>
                <a className="cursor-alter" href="https://1.envato.market/tank" rel="noopener" target="_blank">
                  <img loading="eager" fetchPriority="high" decoding="async" alt="Client" src="/assets/img/tools-logo/vs-code.png" />
                </a>
              </li>
              <li>
                <a className="cursor-alter" href="https://1.envato.market/tank" rel="noopener" target="_blank">
