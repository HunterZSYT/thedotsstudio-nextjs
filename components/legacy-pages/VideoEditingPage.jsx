                ...
                <div className="page-header-inner tt-wrap">
                  ...
                  <div className="ph-image">
                    <div className="ph-image-inner">
                      <img loading="lazy" decoding="async" src="/assets/img/title-pages-hero-images/video-editing.jpg" alt="Image" />
                    </div>
                  </div>
                  ...
                  <div className="ph-caption">
                    <h1 className="ph-caption-title ph-appear">Video Editing</h1>
                    <div className="ph-caption-title-ghost ph-appear">Editing</div>
                    <div className="ph-caption-subtitle ph-appear">Editing that turns views into value.</div>
                  </div> 
                ...
                <div className="tt-section">
                  <div className="tt-section-inner tt-wrap max-width-900">
                    ...
                    <div className="tt-heading tt-heading-lg">
                      ...
                      <h2 className="tt-heading-title">Video Editing</h2>
                ...
                <div className="tt-section padding-bottom-xlg-150">
                  <div className="tt-section-inner tt-wrap">
                    ...
                    <div className="tt-page-nav tt-pn-scroll">
                      <a href="/portfolio-grid-modern" className="tt-pn-link anim-fadeinup">
