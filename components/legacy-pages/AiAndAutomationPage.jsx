                ...
                <div className="page-header-inner tt-wrap">
                  ...
                  <div className="ph-image">
                    <div className="ph-image-inner">
                      <img loading="lazy" decoding="async" src="/assets/img/title-pages-hero-images/ai.jpg" alt="Image" />
                    </div>
                  </div>
                  ...
                  <div className="ph-caption">
                    <h1 className="ph-caption-title ph-appear">Ai and Automation</h1>
                    <div className="ph-caption-title-ghost ph-appear">Automation</div>
                    <div className="ph-caption-subtitle ph-appear">Automate growth, amplify impact.</div>
                  </div> 
                ...
                <div className="tt-section">
                  <div className="tt-section-inner tt-wrap max-width-900">
                    ...
                    <div className="tt-heading tt-heading-lg">
                      ...
                      <h2 className="tt-heading-title">Ai and Automation</h2>
                    ...
                    <div className="portfolio-grid-item">
                      ...
                      <div className="tt-image margin-bottom-40">
                        <figure>
                          <img loading="lazy" decoding="async" className="anim-image-parallax tt-lazy" src="/assets/img/title-pages-hero-images/ai-2.png" data-src="/assets/img/title-pages-hero-images/ai-2.png" alt="image" />
                          <figcaption>
                            Drink Some Water
                          </figcaption>
                        </figure>
